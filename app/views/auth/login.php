    ...
    <div class="flex min-h-screen relative">
        ...
        <div class="hidden lg:flex w-1/2 bg-cover bg-center relative items-center justify-center"
            ...
            <div class="relative z-10 text-center px-12 animate-fadeInUp">
                ...
                <h1 class="text-4xl font-bold leading-tight text-white drop-shadow-md"><?php echo $lang['login_title_jorney']; ?></h1>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 relative z-10">
            ...
            <div class="relative w-full max-w-md bg-surface-elevated/90 backdrop-blur-md p-8 rounded-2xl border border-content-secondary/10 shadow-2xl lg:border-none lg:bg-transparent lg:shadow-none animate-fadeInUp transition-colors duration-500">
                ...
                <h2 class="text-3xl font-bold text-center mb-2 text-content-primary"><?php echo $lang['login_title_welcome']; ?></h2>
                <p class="text-content-secondary text-center mb-8"><?php echo $lang['login_subtitle_welcome']; ?></p>
                ...
                <form id="login-form" action="<?php echo BASE_URL; ?>/login/authenticate" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-content-secondary ml-1"><?php echo $lang['global_senha']; ?></label>
                        <div class="mt-1 relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <label for="remember-me" class="flex items-center cursor-pointer group">
                                ...
                                <span class="block text-sm text-content-secondary select-none"><?php echo $lang['login_remember']; ?></span>
                            </label>
                        </div>
                        <div class="text-sm">
                            <a href="<?php echo BASE_URL; ?>/forgot-password" class="font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 transition-colors"><?php echo $lang['login_forget']; ?></a>
                        </div>
                    </div>
                ...
                <p class="mt-8 text-center text-sm text-content-secondary">
                    ...
                    <a href="<?php echo BASE_URL; ?>/register" class="font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 transition-colors hover:underline"><?php echo $lang['global_menu_register']; ?></a>
                </p>
            </div>
        </div>
    </div>
